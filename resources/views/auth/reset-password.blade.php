<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <h3 class="text-surface-900">Reset Password</h3>
        <p class="mt-1.5 text-surface-500" style="font-size: var(--text-body); letter-spacing: var(--tracking-body);">Enter your new password below</p>
    </div>
