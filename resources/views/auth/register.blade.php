<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Join BookEase and start booking services</p>
    </div>
    ...
    <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
        ...
        <a href="{{ route('login') }}" class="font-semibold text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 transition-colors">
            Sign in
        </a>
    </p>
</x-guest-layout>
