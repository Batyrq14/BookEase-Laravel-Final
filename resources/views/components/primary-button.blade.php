...
@php
    ...
    $baseClasses = 'group relative inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-300 focus-ring disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.97] overflow-hidden';
    $colorClasses = 'bg-brand-600 text-white hover:bg-brand-700 active:bg-brand-800 dark:bg-brand-500 dark:hover:bg-brand-600 dark:active:bg-brand-700';
    $shadowClasses = 'shadow-md shadow-brand-600/20 hover:shadow-lg hover:shadow-brand-600/30 dark:shadow-brand-500/20 dark:hover:shadow-brand-500/30';
@endphp
