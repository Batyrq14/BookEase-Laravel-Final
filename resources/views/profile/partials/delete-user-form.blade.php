<section>
    <div class="mb-6">
        <h2 class="text-base font-semibold text-slate-900 dark:text-white">Delete Account</h2>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-7">
            ...
            <div class="flex items-start gap-4 mb-5">
                ...
                <div>
                    <h3 class="text-base font-semibold text-slate-900 dark:text-white">Are you absolutely sure?</h3>
